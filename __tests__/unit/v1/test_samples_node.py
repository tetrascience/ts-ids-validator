...
files_to_expected = {
    ...
    "missing_nested_essential_properties.json": {
        ...
        labels.TIME: [(
            "'properties' must contain ['lookup']",
            Log.CRITICAL.value
        )],
        location.LOCATION: [(
            "'properties' must contain ['column']",
            Log.CRITICAL.value
        )],
        location.HOLDER: [(
        ...
        properties.PROPERTIES: [(
            "'properties' must contain ['string_value']",
            Log.CRITICAL.value
        )],
        properties.SOURCE: [(
            "'properties' must contain ['name']",
    ...
    "invalid_types_samples_location.json": {
        ...
        location.HOLDER: [(
            "'type' must be object", Log.CRITICAL.value
        )],
