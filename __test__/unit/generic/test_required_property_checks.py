...
UNIT_TEST_FILES = Path("__test__/unit/generic/files/required_property")

fname_to_expected = {
    "required_property_not_defined.json": [("Required Properties are missing", Log.CRITICAL.value)],
}
