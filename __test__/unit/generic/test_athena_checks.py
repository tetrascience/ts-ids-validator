...
UNIT_TEST_FILES = Path("__test__/unit/generic/files/athena")
...
dirs_to_expected = {
    ...
    "inside_array": [("Athena.js: Following paths are either array type or nested in array types: ['results.time']", Log.CRITICAL.value)],
