...
node_name_to_expected = {
    ...
    "_underscore_prefix": [],
    "underscore_suffix_": [],
    "invalid.special.char": [("'invalid.special.char' should be named as snake_case.", Log.CRITICAL.value)],
    "@idsConventionVersion": [],
    "snake_case_1": [],
    "1_snake_case": [],
    "not_snake@case": [("'not_snake@case' should be named as snake_case.", Log.CRITICAL.value)],
    "snake1_case": []
}
